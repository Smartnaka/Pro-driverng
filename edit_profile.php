  ...
  <div class="profile-form">
    ...
    <form id="profile-form" method="POST" enctype="multipart/form-data">
        <div class="text-center">
            <img src="<?= htmlspecialchars($user['profile_picture'] ?? 'images/default-avatar.png') ?>" alt="Profile Picture" id="profile-pic-preview" class="profile-pic-preview">
        </div>
        <div class="row">
            <div class="col-md-6 mb-3"><label class="form-label">First Name</label><input type="text" class="form-control" value="<?= $user['first_name'] ?>" disabled></div>
            <div class="col-md-6 mb-3"><label class="form-label">Last Name</label><input type="text" class="form-control" value="<?= $user['last_name'] ?>" disabled></div>
            ...
            <div class="col-md-6 mb-3"><label class="form-label">Phone</label><input type="text" class="form-control" value="<?= $user['phone'] ?>" disabled></div>
        </div>
      ...
      <div class="row">
          ...
          <div class="col-md-6 mb-3"><label for="occupation" class="form-label">Occupation</label>
            <input type="text" id="occupation" name="occupation" class="form-control" value="<?= htmlspecialchars($user['occupation'] ?? '') ?>">
          </div>
      </div>
      ...
      <div class="mb-3"><label for="upload_id" class="form-label">Upload ID (optional)</label>
        <input type="file" id="upload_id" name="upload_id" class="form-control" accept="image/png, image/jpeg, application/pdf">
        <?php if (!empty($user['upload_id'])): ?>
            <div class="mt-2">Current ID: <a href="<?= htmlspecialchars($user['upload_id']) ?>" target="_blank">View Uploaded ID</a></div>
        <?php endif; ?>
      </div>
